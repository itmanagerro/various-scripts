...
<xsl:template match="product">
	...
	<xsl:variable name="kod" select="kod" /><xsl:value-of select="document('export_client.xml')//item[@kod=$kod]/@price * 1.25" /><xsl:text>|</xsl:text><!-- Price tax excluded or Price tax included -->
